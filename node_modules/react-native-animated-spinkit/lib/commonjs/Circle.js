...
class Circle extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(_AnimationContainer.default, {
      initAnimation: () => ({
        circle: value => (0, _utils.stagger)(100, 12, {
          duration: 1200,
          value: value,
    ...
    }, rest), values.circle.map((value, index) => /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
      key: index,
      style: [circleStyle, {
        transform: [{
...
_defineProperty(Circle, "defaultProps", _SpinnerProps.defaultProps);
