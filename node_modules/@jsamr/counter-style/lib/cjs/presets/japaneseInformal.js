...
const cjkDecimal_1 = __importDefault(require("./cjkDecimal"));
const japaneseInformal = CounterStyle_1.default.additive({
    ...
    .withRange(-9999, 9999)
    .withFallback(cjkDecimal_1.default.withNegative('\u30DE\u30A4\u30CA\u30B9' /* マイナス */))
    .withSuffix(constants_1.CJK_SUFFIX);
exports.default = japaneseInformal;
//# sourceMappingURL=japaneseInformal.js.map